...
class AgreementsControllerTest < ActionController::TestCase
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post :create, agreement: { costume_id: @agreement.costume_id, customer_id: @agreement.customer_id, due: @agreement.due, end: @agreement.end, financer: @agreement.financer, start: @agreement.start, title: @agreement.title }
    end
  ...
  test "should update agreement" do
    patch :update, id: @agreement, agreement: { costume_id: @agreement.costume_id, customer_id: @agreement.customer_id, due: @agreement.due, end: @agreement.end, financer: @agreement.financer, start: @agreement.start, title: @agreement.title }
    assert_redirected_to agreement_path(assigns(:agreement))
  end
